        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Estudiantes_Modalidades_ModalidadId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "PRESENCIAL", true, "Presencial" },
                    { 2, "VIRTUAL", true, "Virtual" },
                    { 3, "MIXTA", true, "Mixta" }
                });

            migrationBuilder.InsertData(
                table: "ProgramasAcademicos",
                columns: new[] { "Id", "Codigo", "Descripcion", "DuracionSemestres", "Estado", "Nivel", "Nombre" },
                values: new object[,]
                {
                    { 1, "ING-SIS", "Programa de Ingeniería de Sistemas", 10, true, "Profesional", "Ingeniería de Sistemas" },
                    { 2, "ADM-EMP", "Programa de Administración de Empresas", 8, true, "Profesional", "Administración de Empresas" },
                    { 3, "CON-ADMON", "Programa de Contaduría Pública", 8, true, "Profesional", "Contaduría Pública" },
                    { 4, "PSI-CLIN", "Programa de Psicología Clínica", 10, true, "Profesional", "Psicología Clínica" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CC", true, "Cédula de Ciudadanía" },
                    { 2, "TI", true, "Tarjeta de Identidad" },
                    { 3, "CE", true, "Cédula de Extranjería" },
                    { 4, "PAS", true, "Pasaporte" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Estudiantes_ModalidadId",
                table: "Estudiantes",
                column: "ModalidadId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgramasAcademicos_Codigo",
                table: "ProgramasAcademicos",
                column: "Codigo",
                unique: true);
